...
```text
default: 'https://cdn.jsdelivr.net/npm/@coinpaprika/widget-currency@1.0.4'
```
...
<div class="coinpaprika-currency-widget" 
     ...
     data-update-active="false" 
     data-update-timeout="30s"></div>
<script src="https://cdn.jsdelivr.net/npm/@coinpaprika/widget-currency@1.0.4/dist/widget.min.js"></script>
```
